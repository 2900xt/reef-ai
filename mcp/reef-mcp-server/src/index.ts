...
async function searchPapers(userId: string, abstract: string): Promise<SearchResponse | ErrorResponse> {
...
server.tool(
  "reef_search",
  "Search for similar research papers using an abstract or description. Returns matching papers ranked by similarity. Costs 1 credit per search.",
  {
