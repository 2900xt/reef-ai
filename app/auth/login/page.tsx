...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 relative flex items-center justify-center">
      {/* Background effects */}
      ...
      <div className="relative z-10 max-w-md w-full mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-cyan-300 text-sm font-medium mb-6 shadow-lg">
          ...
          <p className="text-white/60 text-lg">
            Discover relevant research papers, curated for you
          </p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/10">
          <div className="text-center mb-6">
            ...
            <p className="text-white/50 text-sm">Sign in to access your personalized research feed</p>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3.5 px-6 rounded-xl hover:bg-gray-100 hover:scale-[1.02] transition-all duration-300 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
            {isSigningIn ? (
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <p className="text-white/40 text-xs text-center mb-4">What you'll get</p>
